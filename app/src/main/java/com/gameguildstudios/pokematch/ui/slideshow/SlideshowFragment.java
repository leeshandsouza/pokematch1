package com.gameguildstudios.pokematch.ui.slideshow;
...
public class SlideshowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        sms=root.findViewById(R.id.smsbutton);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        sms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent sms=new Intent(getActivity(), Smsactivity.class);
                sms.putExtra("poke1",label1.getText().toString());
                sms.putExtra("poke2",label3.getText().toString());
                sms.putExtra("poke3",label4.getText().toString());
